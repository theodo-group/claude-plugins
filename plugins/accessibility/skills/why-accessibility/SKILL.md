...
- High-profile accessibility failures have led to public backlash and costly litigation. Notable cases: Domino's Pizza was sued for an inaccessible app and settled after 6 years ([Robles v. Domino's, 2022](https://www.adatitleiii.com/2022/06/robles-v-dominos-settles-after-six-years-of-litigation/)); Beyoncé's website was hit with a class action for lacking alt-text and keyboard navigation ([BuzzFeed News, 2019](https://www.buzzfeednews.com/article/skbaer/blind-woman-sues-beyonce-website-accessibility)).
